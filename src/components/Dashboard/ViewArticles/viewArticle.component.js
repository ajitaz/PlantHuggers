                                        ...
                                        this.state.data.map((result, index) => {
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td>{result.cname}</td>
                                                    <td>
                                                        <Popup trigger={<button className="edit" ><i className="fas fa-pencil-alt"> Edit</i></button>} position="right center" contentStyle={{ height:'auto',width:'700px'}}  modal onClose={() => { this.getArticle() }}>
                                                            {close => (
                                                                <div className="modal">
